...
function add_product($name, $description, $price,$price_2,$sale_type, $img=''){
	global $conn;
	$conn->query("INSERT INTO homes(id, name, description, price,price_2, sale_type, img) VALUES (NULL, '$name','$description','$price','$price_2',$sale_type,'$img')");
	return 1;
}
...
function edit_product($name, $description, $price,$price_2,$sale_type, $img='', $id){
	global $conn;
	if(empty($img)){
		$conn->query("
		UPDATE homes 
